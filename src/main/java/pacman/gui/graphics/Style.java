...
public enum Style {
    ...
    CLASSIC("#FFFF00", "#1818FF", "#000000", "#FF0000", "#FF99CC", "#33FFFF", "#FFCC33", "#F8B090", "#DEDEFF");
    ...
    Style(String pacmanColour, String wallColour, String backgroundColor, String blinkyColour, String pinkyColour,
          String inkyColour, String clydeColour, String pelletColour, String textColour) {
